  ...
  return (
    <section className="flex flex-col items-center mt-16 gap-6 px-3 md:px-6">
      ...
      <p className="text-center max-w-[650px] text-sm leading-7 text-[#353535]">
        آسیب‌های عصبی نیازمند مراقبت ویژه هستند. استفاده از پانسمان‌های تخصصی
        می‌تواند از آسیب بیشتر جلوگیری کرده و شرایط بهتری برای بازسازی بافت‌های
        عصبی فراهم کند.
      </p>
    </section>
  );
...
export default WhyNeuroBandage;
