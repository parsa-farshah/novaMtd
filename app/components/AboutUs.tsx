...
const AboutUs = () => {
  return (
    <div className="flex flex-col gap-9 md:flex-row-reverse md:items-center md:justify-center md:gap-0 mt-[290px] md:mt-[740px] lg:mt-[300px] px-6 py-3 md:px-9 overflow-hidden">
      <AboutUsTxt />
